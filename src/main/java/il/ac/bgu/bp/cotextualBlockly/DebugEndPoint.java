...
public class DebugEndPoint extends Endpoint implements MessageHandler.Whole<String> {
	private static final Logger LOG = Log.getLogger(DebugEndPoint.class);
	...
	public void onMessage(String message) {
		...
		if (this.session != null && this.session.isOpen() && this.remote != null) {
			...
			LOG.info("<< Not echoing back text message [{}]", message);
		}
	}
}